...
public class InsuranceSurveyorDatabase {
    ...
    public void addInsuranceSurveyors(User insuranceSurveyor) {
        ...
        try (Connection conn = dbConn.connection_to_db("postgres", "postgres.orimpphhrfwkilebxiki", "RXj1sf5He5ORnrjS");
             PreparedStatement ps = conn.prepareStatement(query)){
            ps.setString(1, id);
            ps.setString(2, insuranceSurveyor.getUsername());
            ps.setString(3, insuranceSurveyor.getPassword());
            ps.setString(4, "InsuranceSurveyor");
            ps.setString(5, insuranceSurveyor.getFullName());
            ps.setString(6, insuranceSurveyor.getAddress());
            ps.setString(7, insuranceSurveyor.getPhoneNumber());
    ...
    public void updateInsuranceSurveyors(User insuranceSurveyor) {
        ...
        try (Connection conn = dbConn.connection_to_db("postgres", "postgres.orimpphhrfwkilebxiki", "RXj1sf5He5ORnrjS");
            ...
            ps.setString(1, insuranceSurveyor.getUsername());
            ps.setString(2, insuranceSurveyor.getPassword());
            ps.setString(3, insuranceSurveyor.getRole());
            ps.setString(4, insuranceSurveyor.getFullName());
            ps.setString(5, insuranceSurveyor.getAddress());
            ps.setString(6, insuranceSurveyor.getPhoneNumber());
            ps.setString(7, insuranceSurveyor.getId());
    ...
    public void deleteInsuranceSurveyors(String id) {

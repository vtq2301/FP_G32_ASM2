...
public class ClaimManagementController {
    ...
    public void initializeDataForBeneficiaries(String policyOwnerId) {
        this.policyHolderId = policyOwnerId;
        loadBeneficiaryClaims();
        Platform.runLater(this::configureAccessBasedOnRole);
    }

    private void loadBeneficiaryClaims() {
        claimData.setAll(dbService.getClaimsForBeneficiaries(policyHolderId));
        claimsTable.setItems(claimData);
    }
